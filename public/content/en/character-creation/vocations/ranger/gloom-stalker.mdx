...
**Dreadful Strike.** When you attack a creature and hit it with a weapon, you can deal an extra **2d6 Psychic damage**. You can use this benefit **only once per turn**, and you can do so a number of times equal to your **Wisdom modifier** (minimum of once). You regain all expended uses when you finish a **Long Rest**.

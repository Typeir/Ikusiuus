...
- **Sever** _(Requires Longsword or Nullbrand Mastery)_  
  When you hit a creature with a melee attack, you may force a **Charisma saving throw**  
  **DC = 8 + your Proficiency Bonus + your Charisma modifier**

  - On failure, choose one:
    - End a magical effect (concentration, rage, fly, bless)
    - Break a pact or divine tether
    - Suppress a divine boon for 1 minute (immunity, aura, etc.)
...
You gain a **Spell Point Pool of 15**. Regain 1d6 +1 points by **submerging Nullbrand in brine for eight uninterrupted hours**.  

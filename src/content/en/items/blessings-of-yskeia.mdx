...
- **Spellcasting Focus**  
  ...
  - **Greatshield Override**:  
    The shield counts as a **Greatshield (+3 AC)**, but it does **not reduce your movement speed** but does **not impose disadvantage** on Dexterity checks or saving throws. Additionally, while wielded, you gain **+5 feet of movement speed**.

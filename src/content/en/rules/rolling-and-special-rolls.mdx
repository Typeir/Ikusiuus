...
- The action is resisted by **metaphysical forces** (e.g., Fold breaches, artifact activation, curses or blessings).
- The consequences of failure are **catastrophic**, or the action represents a **chain of uncertain steps**.
- The action could **plausibly** happen, if out of sheer luck, but could have adverse **consequences**.

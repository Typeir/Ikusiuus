...
To use a heirloom, it must be **attuned**.

- Attunement requires **one uninterrupted hour spent with the object**, adjusting its Fold-bearing mechanisms to match the user’s body. This may involve breathwork, handling, or fine manipulation depending on the heirloom.
...
- The user is targeted by **Fold Deduplication**, taking **40 points of mixed radiant, necrotic, and force damage**.
- Both heirlooms are **ejected 5 feet away**, no save allowed.

...
- **Crushing Fist.** _Melee Weapon Attack:_ +8 to hit, reach 5 ft., one target.
  _Hit:_ 18 (2d10 + 4) bludgeoning damage.

- **Spinal Latch.** _Ranged Weapon Attack:_ +6 to hit, 30 ft., one target.
  _Hit:_ Target is **grappled and restrained** (escape DC 14) by a wormy chain of bone and tendons.
...
- **Iron Maul.** _Melee Weapon Attack:_ +9 to hit, reach 5 ft., one target.
  _Hit:_ 20 (3d8 + 5) bludgeoning + 2d6 necrotic.
...
- **Still Touch.** _Melee Weapon Attack:_ +7 to hit, reach 5 ft., one target.
  _Hit:_ 14 (3d6 + 4) cold damage and the target is **unable to speak or vocalize** until the end of their next turn.
...
- **Rusted Lance.** _Melee Weapon Attack:_ +8 to hit, reach 10 ft., one target.
  _Hit:_ 2d10 + 4 piercing damage. If the target is frightened or paralyzed, they take **+2d6 necrotic damage**.
